...
namespace App\Http\Controllers\Partner\Team;
...
class TeamController extends Controller
{
    ...
    public function index()
    {
        ...
        return inertia('Partner/Team/Index',[
            'teams' => $teams,
            'members' => $members
        ]);
    }
    ...
    {
        return inertia('Partner/Team/Create');
    }
    ...
    public function show($slug, $id)
    {
        ...
        return inertia('Partner/Team/Show',[
            'team' => $team,
            'stages' => $stages,
            'members' => $members,
            'clients' => $clients,
    ...
    public function edit($slug, $id)
    {
        ...
        return inertia('Partner/Team/Edit',[
            'team' => $team
        ]);
    }
