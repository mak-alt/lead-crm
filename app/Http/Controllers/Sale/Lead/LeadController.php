...
class LeadController extends Controller
{
    ...
    public function index()
    {
        ...
        return inertia('Sale/Lead/Index',[
            'leads' => $leads,
        ]);
    }
    ...
    public function create()
    {
        ...
        return inertia('Sale/Lead/Create',[
            'stages' => $stages,
            'sources' => $sources,
            'timezones' => $timezones,
            'clients' => $clients
    ...
    public function convertLeadToTask(Request $request, $slug, $id)
    {
        ...
        //get lead data
        $lead = Lead::with(['client','media'])->findOrFail($id);
