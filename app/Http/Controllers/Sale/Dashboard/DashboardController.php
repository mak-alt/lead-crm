...
namespace App\Http\Controllers\Sale\Dashboard;
...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return inertia('Sale/Dashboard/Index',[
            'data' => $data
        ]);
    }
    ...
    public function singleWebAnalytics(Request $request)
    {
        ...
        $tasks = Task::with(['website','members','user','taskStage'])->latest()->take(10)->whereWebsiteId($request->website_id)->get();
    ...
    public function singleDashboard(){
        ...
        $recent_leads = Lead::with(['stage','user','client'])->whereWebsiteId(core()->currentWebsite()->id)->whereUserId(auth()->user()->id)->latest()->take(10)->get();
        return inertia('Sale/Dashboard/Single',[
            'website' => $website,
