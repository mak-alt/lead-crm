...
namespace App\Http\Controllers\Prod\Dashboard;
...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return inertia('Prod/Dashboard/Index',[
            'data' => $data
        ]);
    }
    ...
    public function singleDashboard(){
        ...
        $recent_tasks = Task::with(['taskStage','members'])->whereWebsiteId(core()->currentWebsite()->id)->whereHas('members',function($query){
            $query->where('users.id',auth()->user()->id);
        })->parent()->latest()->take(10)->get();
        return inertia('Prod/Dashboard/Single',[
            'website' => $website,
