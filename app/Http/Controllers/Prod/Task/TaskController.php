...
namespace App\Http\Controllers\Prod\Task;
...
class TaskController extends Controller
{
    ...
    {
        $tasks = Task::with(['taskStage','user','members','taskStage.team'])
                    ->when(request()->search,function($query){
                        return $query->where('task_no',request()->search);
                    })
        ...
        return inertia('Prod/Task/Index',[
            'tasks' => $tasks
        ]);
    }
