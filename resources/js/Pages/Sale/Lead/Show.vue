...
<script>
    ...
    import Discussion from '@/Pages/Sale/Lead/Partials/Discussion'
    import DiscussionForm from '@/Pages/Sale/Lead/Partials/DiscussionForm'
    import CreateResource from '@/Pages/Sale/Lead/Partials/CreateResource'
    import RefundModal from '@/Pages/Sale/Lead/Partials/RefundModal'
    import CreatePayment from '@/Pages/Sale/Lead/Partials/CreatePayment'
    import ExpectedPayment from '@/Pages/Sale/Lead/Partials/ExpectedPayment'
    import RefundPartialModal from '@/Pages/Sale/Lead/Partials/RefundPartialModal'
    ...
    export default {
        ...
        methods: {
            getDiscussions() {
                axios.get(route('sales.leads.discussions', { slug: this.currentWebsite.slug }), { params: { lead_id: this.lead.id } }).then((response) => {
            ...
            addDiscussion(comment) {
                axios.post(route('sales.leads.discussions.store', { slug: this.currentWebsite.slug }), { lead_id: this.lead.id, comment: comment.comment }).then((response) => {
            ...
            refundPayment() {
                this.refund.post(route('sales.leads.payments.update', { slug: this.currentWebsite.slug, id: this.refund.id }),{
                    preserveScroll: true,
                    onSuccess: () => this.hideRefundModal()
                });
            },
            createPayment() {
                this.create_payment.post(route('sales.leads.payments.store', { slug: this.currentWebsite.slug }), {
                    preserveScroll: true,
                    onSuccess: () => {
            ...
            updateLead() {
                this.update_lead.post(route('sales.leads.update.expected.amount', { slug: this.currentWebsite.slug, id: this.lead.id }),{
                    onSuccess: () => {
            ...
            uploadResource() {
                ...
                this.resource.post(route('sales.leads.upload.media', { slug: this.currentWebsite.slug, id: this.lead.id }),{
                    preserveScroll: true,
                    onSuccess: () => {
                        this.resource.myFiles = [];
                        this.resource.reset();
            ...
            convertLeadToTask() {
                this.convert.post(route('sales.leads.convert.task', { slug: this.currentWebsite.slug, id: this.lead.id }),{
                    preserveScroll: true,
                    onSuccess: () => {
                        this.convert.reset('');
                    }
            ...
            refundPartialPayment() {
                this.refund_partial.post(route('sales.leads.payments.refund.partial', { slug: this.currentWebsite.slug }),{
                    preserveScroll: true,
