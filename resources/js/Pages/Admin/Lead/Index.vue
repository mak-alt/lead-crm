                                        ...
                                        <div class="row g-4 align-items-center">
                                            ...
                                            <div class="col-sm-auto ms-auto">
                                                <div class="hstack gap-2">
                                                    ...
                                                    <Link :href="route('admin.leads.create', { slug: currentWebsite.slug })" class="btn btn-primary" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Add Leads</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr v-for="lead,index in leads.data" :key="lead.id">
                                                    ...
                                                    <td>
                                                        <Link :href="route('admin.leads.show', { slug: currentWebsite.slug, id: lead.id })">{{ lead.lead_no }}</Link>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="hstack gap-3 flex-wrap">
                                                            <Link :href="route('admin.leads.show',{slug: currentWebsite.slug, id: lead.id})" class="link-success fs-15"><i class="ri-eye-line"></i></Link>
                                                            <Link :href="route('admin.leads.edit',{slug: currentWebsite.slug, id: lead.id})" class="link-success fs-15"><i class="ri-edit-2-line"></i></Link>
...
<script>
    ...
    export default {
        ...
        methods: {
            filter() {
                this.filters.get(route('admin.leads',{ slug: this.currentWebsite.slug }),{
                    preserveState: true,
                    preserveScroll: true    
                })
            },
            ...
            bulkDelete(){
                if(this.bulk_delete.all_ids.length > 0){
                    this.bulk_delete.post(route('admin.leads.bulk.delete', { slug: this.currentWebsite.slug }), {
                        preserveScroll: true,
                        preserveState: true
                    });
                }
