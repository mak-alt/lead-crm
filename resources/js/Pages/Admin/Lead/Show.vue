                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12 mb-3">
                            ...
                            :files="resource.myFiles"
                             />
                             <div v-if="resource.errors.myFiles" class="form-error invalid-feedback">{{ resource.errors.myFiles }}</div>
                        </div>
                        <div class="col-xl-12 col-md-12">
                            <div class="d-grid">
...
<script>
	...
	import Discussion from '@/Pages/Admin/Lead/Partials/Discussion'
	import DiscussionForm from '@/Pages/Admin/Lead/Partials/DiscussionForm'
    import CreateResource from '@/Pages/Admin/Lead/Partials/CreateResource'
    import RefundModal from '@/Pages/Admin/Lead/Partials/RefundModal'
    import CreatePayment from '@/Pages/Admin/Lead/Partials/CreatePayment'
    import ExpectedPayment from '@/Pages/Admin/Lead/Partials/ExpectedPayment'
	...
	export default {
		...
		methods: {
			getDiscussions() {
				axios.get(route('admin.leads.discussions', { slug: this.currentWebsite.slug }), { params: { lead_id: this.lead.id } }).then((response) => {
			...
			addDiscussion(comment) {
				axios.post(route('admin.leads.discussions.store', { slug: this.currentWebsite.slug }), { lead_id: this.lead.id, comment: comment.comment }).then((response) => {
            ...
            refundPayment() {
                this.refund.post(route('admin.leads.payments.update', { slug: this.currentWebsite.slug, id: this.refund.id }),{
                    preserveScroll: true,
                    onSuccess: () => this.hideRefundModal()
                });
            },
            createPayment() {
                this.create_payment.post(route('admin.leads.payments.store', { slug: this.currentWebsite.slug }), {
                    preserveScroll: true,
                    onSuccess: () => {
            ...
            updateLead() {
                this.update_lead.post(route('admin.leads.update.expected.amount', { slug: this.currentWebsite.slug, id: this.lead.id }),{
                    onSuccess: () => {
            ...
            uploadResource() {
                ...
                this.resource.post(route('admin.leads.upload.media', { slug: this.currentWebsite.slug, id: this.lead.id }),{
                    preserveScroll: true,
                    onSuccess: () => {
                        this.resource.myFiles = [];
                        this.resource.reset();
