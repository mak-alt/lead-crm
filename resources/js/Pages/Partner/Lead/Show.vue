...
<script>
    ...
    export default {
        ...
        methods: {
            getDiscussions() {
                axios.get(route('partner.leads.discussions', { slug: this.currentWebsite.slug }), { params: { lead_id: this.lead.id } }).then((response) => {
            ...
            addDiscussion(comment) {
                axios.post(route('partner.leads.discussions.store', { slug: this.currentWebsite.slug }), { lead_id: this.lead.id, comment: comment.comment }).then((response) => {
            ...
            refundPayment() {
                this.refund.post(route('partner.leads.payments.update', { slug: this.currentWebsite.slug, id: this.refund.id }),{
                    preserveScroll: true,
                    onSuccess: () => this.hideRefundModal()
                });
            },
            createPayment() {
                this.create_payment.post(route('partner.leads.payments.store', { slug: this.currentWebsite.slug }), {
                    preserveScroll: true,
                    onSuccess: () => {
            ...
            updateLead() {
                this.update_lead.post(route('partner.leads.update.expected.amount', { slug: this.currentWebsite.slug, id: this.lead.id }),{
                    onSuccess: () => {
            ...
            uploadResource() {
                ...
                this.resource.post(route('partner.leads.upload.media', { slug: this.currentWebsite.slug, id: this.lead.id }),{
                    preserveScroll: true,
                    onSuccess: () => {
                        this.resource.myFiles = [];
                        this.resource.reset();
