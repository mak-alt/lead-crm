                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><Link :href="route('partner.single.dashboard',{ slug: currentWebsite.slug })">Dashboard</Link></li>
                            ...
                            <div class="card card-body">
                               <div class="d-flex mb-4">
                                  <div class="flex-grow-1">
                                     <h5 class="card-title mb-1"><Link :href="route('partner.teams.show', { slug: currentWebsite.slug, id: team.id })">{{ team.name }}</Link></h5>
                                     <p class="text-muted mb-0 fs-16"><Link :href="route('partner.teams.show', { slug: currentWebsite.slug, id: team.id })">{{ team.team_no }}</Link></p>
                                  </div>
...
<script>
    ...
    import CreateModal from '@/Pages/Partner/Team/Partials/CreateModal'
    import EditModal from '@/Pages/Partner/Team/Partials/EditModal'
    ...
    export default {
        ...
        methods: {
        	filter() {
        		this.filters.get(route('partner.teams', { slug: this.currentWebsite.slug}),{
        			preserveState: true,
	                preserveScroll: true	
        		})
        	},
            ...
            bulkDelete(){
                if(this.bulk_delete.all_ids.length > 0){
                    this.bulk_delete.post(route('partner.teams.bulk.delete', { slug: this.currentWebsite.slug }));
                }
            },
            showCreateModal() {
            ...
            createTeam() {
                this.form.post(route('partner.teams.store', { slug: this.currentWebsite.slug }),{
                    preserveScroll: true,
                    onSuccess: () => {
            ...
            updateTeam() {
                this.edit.post(route('partner.teams.update', { slug: this.currentWebsite.slug, id: this.edit.id }),{
                    preserveScroll: true,
                    onSuccess: () => {
                        this.hideEditModal(),
                        this.form.reset()
