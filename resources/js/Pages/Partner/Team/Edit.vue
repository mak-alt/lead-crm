                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><Link :href="route('partner.dashboard', { slug: currentWebsite.slug })">Dashboards</Link></li>
                                    <li class="breadcrumb-item"><Link :href="route('partner.teams', { slug: currentWebsite.slug})">Teams</Link></li>
...
<script>
    ...
    export default {
        ...
        methods: {
            save() {
                this.form.post(route('partner.teams.update', { id: this.team.id, slug: this.currentWebsite.slug }),{
                    preserveScroll: true,
